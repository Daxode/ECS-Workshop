...
namespace Daxode.MethodReference.Editor {
    ...
    static class MethodReferenceDrawerUtility {
        internal static void AddMethodReferencePicker(this VisualElement container, SerializedProperty property, Type propertyDelegateType, string nameOverride) {
            ...
            methodSelectionField.RegisterValueChangedCallback(e
                => e.newValue.TryApplyTo(typeNameProperty, nameProperty, overloadIndexProperty, hasBurstCompileAttributeProperty)); container.Add(methodSelectionField);
        }
